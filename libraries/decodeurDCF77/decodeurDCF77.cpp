...
bool decodeurDCF77_c::traiterSignal(uint8_t signal, uint32_t millis_signal)
{
  ...
  //Ici on ne laisse passer qu'un échantillon maximum par milliseconde
...
//Ici on alimente le tuner DCF77 pour le suivi de la qualité du signal
  if (signal)
  {
...
//Ici on recherche la pulsation des fronts montants à 1 Hz
...
//Ici on élimine les fronts montants trop loin de la pulsation
...
//Ici on décode les bits de la trame
  bool pas_fini = true;
...
{
//Déplace la reference de pulsation par bonds de 1000 ms
//pour la placer dans une fourchette de temps comprise entre +0 ms et +999ms
//par rapport à millis_reference

                                 ...
                                 uint8_t *heure, uint8_t *minute, bool *heure_ete)
{
  ...
  //Contrôles plages de valeur
  if (a > 99 || m < 1 || m > 12 || j < 1 || j > 31 || js < 1 || js > 7 || hh > 23 || mm > 59)
  {
    return false;
  }

  //Contrôle validité de la date
  ...
  //Contrôle validité du flag heures d'été pour chaque mois hors mars et octobre
  if ((ete && (m < 3 || m > 10))
   || ((!ete) && m > 3 && m < 10))
  {
    return false;
  ...
  //Contrôle validité du flag heures d'été en mars
  if (m == 3)
  {
  ...
  //Contrôle validité du flag heures d'été en octobre
  if (m == 10)
  {
  ...
  //Contrôle validité du jour de la semaine

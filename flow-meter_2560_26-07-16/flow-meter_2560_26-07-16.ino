...
float Click_Per_L = 567; // this depends on your flow meter
...
unsigned long PulseCount;  //counter for water meter pulses
long Second;
long Last_Reading;
int Readings;
float Water_Used;
...
stringOne =  "+++ Total used:"+String(Water_Used)+"- Max Flow:"+String(Max_Flow_Rate)+"+++";
